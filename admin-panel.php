...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> &nbsp STONECOLD HOSPITALS</a>
  ...
  <style >
    .bg-primary {
      background: -webkit-linear-gradient(left, #009FFD, #2A2A72
    );
}
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit" onclick="alert('Bill Paid Successfully');"  class = "btn btn-success" value="Pay Bill"/>
                              </a>
                              </td>
                              </form>
