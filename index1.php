...
<html lang="en">
  <head>
    ...
    <title>STONECOLD HOSPITALS</title>  
  ...
  <body>
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp STONECOLD HOSPITALS</h4></a>
    ...
    <div class="container-fluid register" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      <div class="row">

      <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
        <img src="images/login.jpg" alt="" style="height:150px;width:150px;"/><br>
         <h3>Welcome Back!</h3>         
        </div>
